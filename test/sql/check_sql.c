...
START_TEST(check_tabledata)
{
	...
	M_sql_tabledata_t td[] = {
		...
		{ "col2", "col2", NULL, 32,  M_SQL_DATA_TYPE_TEXT,  0 },
		{ "col3", "tag1", NULL, 128, M_SQL_DATA_TYPE_TEXT,  M_SQL_TABLEDATA_FLAG_EDITABLE|M_SQL_TABLEDATA_FLAG_VIRTUAL },
		{ "col3", "tag2", NULL, 128, M_SQL_DATA_TYPE_TEXT,  M_SQL_TABLEDATA_FLAG_EDITABLE|M_SQL_TABLEDATA_FLAG_VIRTUAL },
		{ "col3", "tag3", NULL, 128, M_SQL_DATA_TYPE_TEXT,  M_SQL_TABLEDATA_FLAG_VIRTUAL },
		{ "col4", "col4", NULL, 32,  M_SQL_DATA_TYPE_TEXT,  0 },
	};
	M_hash_dict_t *dict; 
	M_sql_stmt_t  *stmt;
	M_sql_table_t *table   = NULL;
