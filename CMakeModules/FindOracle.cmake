...
set(_paths)
if (WIN32)
	append_glob_dirs(_paths "$ENV{ProgramFiles}/Oracle/oci*/")
	append_glob_dirs(_paths "$ENV{ProgramFiles\(x86\)}/Oracle/oci*/")
	append_glob_dirs(_paths "$ENV{ProgramFiles}/Oracle/*/oci/")
	append_glob_dirs(_paths "$ENV{ProgramFiles\(x86\)}/Oracle/*/oci/")
	append_glob_dirs(_paths "$ENV{ProgramFiles}/Oracle/instantclient*/")
	append_glob_dirs(_paths "$ENV{ProgramFiles\(x86\)}/Oracle/instantclient*/")
	append_glob_dirs(_paths "$ENV{ProgramFiles}/instantclient*/")
	append_glob_dirs(_paths "$ENV{ProgramFiles\(x86\)}/instantclient*/")
	append_glob_dirs(_paths "$ENV{ProgramFiles}/instantclient/*/")
	append_glob_dirs(_paths "$ENV{ProgramFiles\(x86\)}/instantclient/*/")
